...
import org.wso2.openbanking.fdx.extensions.impl.dcr.PreProcessClientCreationApiImpl;
...
import org.wso2.openbanking.fdx.extensions.model.Response200ForClientProcess;
...
public class PreProcessClientCreationApi {
    ...
    public Response preProcessClientCreationPost(@Valid @NotNull ClientProcessRequestBody clientProcessRequestBody) {
        return PreProcessClientCreationApiImpl.handleDCRClientCreation(clientProcessRequestBody);
    }
}
