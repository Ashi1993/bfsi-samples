...
public class SuccessResponsePopulateConsentAuthorizeScreenDataConsentData {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, basicConsentData, permissions, initiatedAccountsForConsent, allowMultipleAccounts, handleAccountSelectionSeparately, isReauthorization, consentMetadata, super.hashCode());
  }
